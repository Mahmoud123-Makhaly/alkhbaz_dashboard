...
import { recentOrders } from '@assets/data/velzon';
              ...
              <table className="table table-borderless table-centered align-middle table-nowrap mb-0">
                ...
                <tbody>
                  {(recentOrders || []).map((item, key) => (
                    <tr key={key}>
                      <td>
                        <Link href="/apps-ecommerce-order-details" className="fw-medium link-primary">
                          {item.orderId}
                        </Link>
                      </td>
                      <td>
                        <div className="d-flex align-items-center">
                          <div className="flex-shrink-0 me-2">
                            <img src={item.img.src} alt="" className="avatar-xs rounded-circle" />
                          </div>
                      ...
                      <td>
                        <h5 className="fs-14 fw-medium mb-0">
                          {item.rating}
                          <span className="text-muted fs-11 ms-1">({item.votes} votes)</span>
                        </h5>
                      </td>
                    </tr>
                  ))}
