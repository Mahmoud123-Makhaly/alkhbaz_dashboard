...
//import images
import product8 from '@assets/img/products/img-8.png';
import product2 from '@assets/img/products/img-2.png';
import product10 from '@assets/img/products/img-10.png';
import avatar2 from '@assets/img/users/avatar-2.jpg';
import avatar3 from '@assets/img/users/avatar-3.jpg';
import gitbox from '@assets/img/giftbox.png';

//SimpleBar
import SimpleBar from 'simplebar-react';
import { topCategories } from '@assets/data/velzon/index';
                ...
                <div className="acitivity-timeline acitivity-main">
                    ...
                    <div className="flex-grow-1 ms-3">
                      ...
                      <div className="d-inline-flex gap-2 border border-dashed p-2 mb-2">
                        <Link href="/apps-ecommerce-product-details" className="bg-light rounded p-1">
                          <img src={product8.src} alt="" className="img-fluid d-block" />
                        </Link>
                        <Link href="/apps-ecommerce-product-details" className="bg-light rounded p-1">
                          <img src={product2.src} alt="" className="img-fluid d-block" />
                        </Link>
                        <Link href="/apps-ecommerce-product-details" className="bg-light rounded p-1">
                          <img src={product10.src} alt="" className="img-fluid d-block" />
                        </Link>
                      </div>
                  ...
                  <div className="acitivity-item py-3 d-flex">
                    <div className="flex-shrink-0">
                      <img src={avatar2.src} alt="" className="avatar-xs rounded-circle acitivity-avatar" />
                    </div>
                    <div className="flex-grow-1 ms-3">
                  ...
                  <div className="acitivity-item py-3 d-flex">
                    ...
                    <div className="flex-grow-1 ms-3">
                      <h6 className="mb-1 lh-base">
                        Today offers by
                        <Link href="/apps-ecommerce-seller-details" className="link-secondary">
                          Digitech Galaxy
                        </Link>
                      </h6>
                  ...
                  <div className="acitivity-item py-3 d-flex">
                    ...
                    <div className="flex-grow-1 ms-3">
                      ...
                      <p className="text-muted mb-2">
                        ...
                        report.
                        <Link href="#" className="link-warning text-decoration-underline">
                          Reports Builder
                        </Link>
                      </p>
                  ...
                  <div className="acitivity-item d-flex">
                    <div className="flex-shrink-0">
                      <img src={avatar3.src} alt="" className="avatar-xs rounded-circle acitivity-avatar" />
                    </div>
                    <div className="flex-grow-1 ms-3">
