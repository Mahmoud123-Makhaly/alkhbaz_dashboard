...
const RevenueCharts = ({ dataColors, series }) => {
  ...
  return (
    <React.Fragment>
      <ApexChart dir="ltr" options={options} series={series} type="line" height="370" className="apex-charts" />
    </React.Fragment>
  );
};
...
const StoreVisitsCharts = ({ dataColors }) => {
  ...
  return (
    <React.Fragment>
      <ApexChart dir="ltr" options={options} series={series} type="donut" height="333" className="apex-charts" />
    </React.Fragment>
  );
};
