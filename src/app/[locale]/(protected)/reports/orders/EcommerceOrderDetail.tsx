...
import { productDetails } from '@assets/data/velzon/ecommerce';
              ...
              <CardHeader>
                <div className="d-flex align-items-center">
                  ...
                  <div className="flex-shrink-0">
                    <Link href="/apps-invoices-details" className="btn btn-success btn-sm">
                        ...
                        <td colSpan={2} className="fw-medium p-0">
                          <table className="table table-borderless mb-0">
                            <tbody>
                              ...
                              <tr>
                                <td>
                                  Discount <span className="text-muted">(ALKHBAZ15)</span> : :
                                </td>
              ...
              <CardHeader>
                <div className="d-sm-flex align-items-center">
                  ...
                  <div className="flex-shrink-0 mt-2 mt-sm-0">
                    <Link href="#" className="btn btn-soft-info btn-sm mt-2 mt-sm-0">
                      <i className="ri-map-pin-line align-middle me-1"></i> Change Address
                    </Link>
                    <Link href="#" className="btn btn-soft-danger btn-sm mt-2 mt-sm-0">
                  ...
                  <div className="accordion accordion-flush" id="accordionFlushExample">
                    <div className="accordion-item border-0" onClick={togglecol1}>
                      <div className="accordion-header" id="headingOne">
                        <Link
                          href="#"
                          className={classnames('accordion-button', 'p-2', 'shadow-none', { collapsed: !col1 })}
                        >
                          <div className="d-flex align-items-center">
                    ...
                    <div className="accordion-item border-0">
                      <div className="accordion-header" id="headingFive">
                        <Link className="accordion-button p-2 shadow-none" href="#">
                          <div className="d-flex align-items-center">
                            <div className="flex-shrink-0 avatar-xs">
                              <div className="avatar-title bg-light text-success rounded-circle">
            ...
            <Card>
              <CardHeader>
                <div className="d-flex">
                  ...
                  <div className="flex-shrink-0">
                    <Link href="#" className="badge badge-soft-primary fs-11">
                      Track Order
                    </Link>
                  </div>
                </div>
              ...
              <CardBody>
                <ul className="list-unstyled mb-0 vstack gap-3">
                  <li>
                    <div className="d-flex align-items-center">
                      <div className="flex-shrink-0">
                        <img src={avatar3.src} alt="" className="avatar-sm rounded" />
                      </div>
                      <div className="flex-grow-1 ms-3">
